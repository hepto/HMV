...
class HMVTests: XCTestCase {
    ...
    func testSearch() throws {
        ...
        let client = HMV(urlBuilder: MockUrlBuilder(), urlFetcher: MockUrlFetcher(data: data, error: nil, expectedRequest: expectedRequest))
...
#if os(Linux)
    extension HMVTests {
        static var allTests: [(String, (HMVTests) -> () throws -> Void)] {
            return [
